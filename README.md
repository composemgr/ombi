...
Request and discovery platform for media servers
...
```bash
curl -q -LSsf "https://raw.githubusercontent.com/composemgr/ombi/main/docker-compose.yaml" -o compose.yml
```
...
- **Web Interface**: http://172.17.0.1:3579
